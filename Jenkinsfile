node {
  ...
  dir('build') {
    stage 'Configure'
    sh 'cmake -G Ninja -DCMAKE_CXX_COMPILER=clang++37 -DCMAKE_C_COMPILER=clang37 -C ../cmake-caches/$JOB_NAME.cmake -DLLVM_EXTERNAL_CLANG_SOURCE_DIR=../clang -DLLVM_EXTERNAL_LLD_SOURCE_DIR=../lld -DLLVM_EXTERNAL_CLANG_TOOLS_EXTRA_SOURCE_DIR=../clang-tools-extra -DLLVM_EXTERNAL_COMPILER_RT_SOURCE_DIR=../compiler-rt ../llvm'
